...
3. Utwórz ściany za pomocą zakładki Modifiers
	1. Dodaj modifier Solidify
	2. Ustaw grubość ściany w Thickness na 0.2 m
	3. Zaznacz pole Even Thickness
	3. Offset 1.0, ściany utworzą się na zewnątrz, żeby zachować poprawne wymiary pomieszczenia.
	4. Zatwierdzić modifier CTRL-A
4. Dodaj materiał do obiektu pomieszczenia stosując nazewnictwo materiałów z listy materiałów
